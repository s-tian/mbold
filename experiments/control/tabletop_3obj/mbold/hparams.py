...
policy = {
    ...
    'learned_cost_model_path': os.environ['VMPC_EXP'] + '/classifier_control/distfunc_training/q_func_training/tabletop_3obj/weights/weights_ep300.pth',
    "vidpred_model_path": os.environ['VMPC_EXP'] + '/vpred_models/threeobj_tabletop/checkpoint_200000', # Video prediction model location

...
policy = {
    ...
    'learned_cost_model_path': os.environ['VMPC_EXP'] + '/classifier_control/distfunc_training/tdist_reg_training/tabletop_3obj/weights/weights_ep995.pth',
    'verbose_every_iter': True,
    "vidpred_model_path": os.environ['VMPC_EXP'] + '/vpred_models/threeobj_tabletop/checkpoint_200000',
    'finalweight': -10000,
}
